...
// Ползваме го за да запълним БД с начални данни (само ако е празна)
@Configuration
...
public class DataInitializer {
    ...
    CommandLineRunner seedDatabase(
        ...
        return args -> {
            // Не добавяме данни ако вече има лекари в БД
            ...
            Doctor gp1 = doctorRepo.save(Doctor.builder()
                    .name("Д-р Иван Иванов").specialty("Обща медицина").isGp(true).build());
            Doctor gp2 = doctorRepo.save(Doctor.builder()
                    .name("Д-р Мария Петрова").specialty("Обща медицина").isGp(true).build());
            Doctor specialist1 = doctorRepo.save(Doctor.builder()
                    .name("Д-р Георги Георгиев").specialty("Кардиология").isGp(false).build());
            Doctor specialist2 = doctorRepo.save(Doctor.builder()
                    .name("Д-р Елена Стоянова").specialty("Неврология").isGp(false).build());
            Doctor specialist3 = doctorRepo.save(Doctor.builder()
                    .name("Д-р Петър Димитров").specialty("Ортопедия").isGp(false).build());

            // ----------------------------------------------------------
            // Пациенти
            // ----------------------------------------------------------
            Patient p1 = patientRepo.save(Patient.builder()
                    .name("Стефан Стефанов").egn("8501011234")
                    .insured(true).gpDoctor(gp1).build());
            Patient p2 = patientRepo.save(Patient.builder()
                    .name("Анна Николова").egn("9203025678")
                    .insured(false).gpDoctor(gp1).build());
            Patient p3 = patientRepo.save(Patient.builder()
                    .name("Тодор Тодоров").egn("7807139012")
                    .insured(true).gpDoctor(gp2).build());
            Patient p4 = patientRepo.save(Patient.builder()
                    .name("Виктория Василева").egn("0005173456")
                    .insured(false).gpDoctor(gp2).build());
            Patient p5 = patientRepo.save(Patient.builder()
                    .name("Кирил Кирилов").egn("8811227890")
                    .insured(true).gpDoctor(gp1).build());
            ...
            Diagnosis flu       = diagnosisRepo.save(Diagnosis.builder()
                    .name("Грип").description("Остро вирусно заболяване на дихателните пътища").build());
            Diagnosis hypertension = diagnosisRepo.save(Diagnosis.builder()
                    .name("Хипертония").description("Повишено артериално налягане").build());
            Diagnosis diabetes  = diagnosisRepo.save(Diagnosis.builder()
                    .name("Диабет тип 2").description("Нарушен глюкозен метаболизъм").build());
            Diagnosis angina    = diagnosisRepo.save(Diagnosis.builder()
                    .name("Ангина").description("Остро възпаление на сливиците").build());
            Diagnosis migraine  = diagnosisRepo.save(Diagnosis.builder()
                    .name("Мигрена").description("Повтарящо се главоболие").build());
            ...
            examinationRepo.saveAll(List.of(
                    Examination.builder()
                            ...
                            .doctor(gp1).patient(p1).diagnosis(flu)
                            .sickLeave(sl1).build(),
                    ...
                    Examination.builder()
                            ...
                            .doctor(specialist1).patient(p2).diagnosis(hypertension)
                            .build(),
                    ...
                    Examination.builder()
                            ...
                            .doctor(gp2).patient(p3).diagnosis(diabetes)
                            .sickLeave(sl2).build(),
                    ...
                    Examination.builder()
                            ...
                            .doctor(gp1).patient(p4).diagnosis(angina)
                            .sickLeave(sl3).build(),
                    ...
                    Examination.builder()
                            ...
                            .doctor(specialist2).patient(p5).diagnosis(migraine)
                            .build(),
                    ...
                    Examination.builder()
                            ...
                            .price(new BigDecimal("25.00"))
                            .treatment("Почивка, антивирусни")
                            .doctor(gp2).patient(p1).diagnosis(flu)
                            .build(),
                    ...
                    Examination.builder()
                            ...
                            .doctor(specialist1).patient(p3).diagnosis(hypertension)
                            .build()
            ));

            System.out.println("=== DataInitializer: начални данни заредени успешно ===");
        };
    }
}
